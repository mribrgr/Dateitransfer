...
12. **Optional**: Bei Interesse können Sie einzelne Klassen oder den Beleg auch in Kotlin programmieren.
13. **Optional**: Bei Interesse können Sie zusätzlich das GbN- oder Selective-Repeat-Protokoll implementieren.
